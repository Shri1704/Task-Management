...
public interface EmployeeRepository extends JpaRepository<Employee, UUID> {
    ...
    @Query("SELECT DISTINCT e FROM Employee e JOIN e.tasks t WHERE t.status = :status")
    List<Employee> findEmployeesByTaskStatus(@Param("status") Contants.TASK_STATUS status);
